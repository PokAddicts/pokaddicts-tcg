...
//
// Reintroduced after the TCGdex migration - TCGdex's own pricing for
// Japanese secret/art rares proved unreliable (a Japanese Magikarp secret
// rare priced at 0.08 EUR on TCGdex vs a real ~175 EUR/USD on PokeWallet,
// for the same physical card) - so PokeWallet is now used specifically as
// the pricing source for Japanese-language cards, while TCGdex remains
// the catalog/search/English-pricing backbone.
